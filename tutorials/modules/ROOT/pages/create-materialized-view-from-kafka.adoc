...
. Click *Create Kafka cluster API key* and enter the name of your {hazelcast-cloud} cluster in the description. This name helps you remember that {hazelcast-cloud} is using that API key the next time you view them in Confluent Cloud.
