= Dedicated Clusters
:description: {hazelcast-cloud} Dedicated gives you fine-grained control over the hardware and resources available to your cluster. It's your responsibility to scale your clusters when you need more resources. Dedicated clusters also offer strict container isolation for projects that require enhanced data security.
:page-dedicated: true
