...
This option provides the easiest way of creating an AWS VPC Peering with your {hazelcast-cloud} cluster.
...
You need to collect AWS VPC Peering properties for your {hazelcast-cloud} cluster on AWS in order to create your side of the AWS VPC Peering connection. 
