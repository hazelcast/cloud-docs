...
When you have at least one backup, you can use it to bootstrap a new cluster. The new cluster is created using the xref:release-notes.adoc[current Hazelcast version]. All versions are backwardly compatible.
...
. Click *Restore Data to a New Cluster* to deploy your new cluster. To check the Hazelcast version of the new cluster, go to the dashboard and view the *Cluster Details*.
