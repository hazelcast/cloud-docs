...
- A release focused on a service quality, security and performance. It brings many enhancements and improvements under the hood of Hazelcast Cloud.

- UI for configuring the data structures extended with a contextual help to help you navigate through the config options.
