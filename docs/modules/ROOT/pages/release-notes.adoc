...
All bug fixes and improvements are for the Hazelcast {hazelcast-cloud} Serverless edition of Hazelcast {hazelcast-cloud} Cloud Managed Services unless otherwise stated.
