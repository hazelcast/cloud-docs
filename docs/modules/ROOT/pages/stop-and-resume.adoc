...
If you're using a Serverless production cluster or a Dedicated cluster, {hazelcast-cloud} saves your cluster data so that you can resume the cluster at a later time.
