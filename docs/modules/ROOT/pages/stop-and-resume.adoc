...
Pausing your cluster can help minimize your costs because you are charged only for running clusters. Development clusters are paused automatically when you don't connect to the cluster for 6 hours. 
