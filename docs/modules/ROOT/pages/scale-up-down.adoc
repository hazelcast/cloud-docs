...
:description: Scaling clusters is useful when you need to scale out for more memory or when you aren't using as much memory as you thought and want to scale in to save on the monthly costs. You can easily scale Dedicated clusters out or in, using a sliding scale that adds or removes cluster members.
:page-dedicated: true
