= User MFA Settings
:description: If enabled at organization level, you must enable Multi-factor Authentication (MFA). If disabled, you can choose whether or not to enable MFA for your sign-in. By default, MFA is disabled.
...
If your organization has not enabled MFA for all users, you can disable it at any time to sign in without an extra authentication step.
