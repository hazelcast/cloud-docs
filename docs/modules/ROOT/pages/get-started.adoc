...
. In the {hazelcast-cloud} console, go to *Manage Cluster* > *Management Center* and click *SQL Browser* in the top toolbar.
...
See the xref:hazelcast:sql:sql-statements.adoc[SQL reference].
