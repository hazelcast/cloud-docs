...
As well as the data that you add to data structures such as maps, you are charged for any additional memory usage, including more than one backup of a data structure on a cluster. *Backups to disk are free*. Additional memory usage may include the following:
