...
module.exports.register = function () {
    let content
    this
        .on('documentsConverted', ({playbook, siteAsciiDocConfig, siteCatalog, uiCatalog, contentCatalog}) => {
            console.log(playbook, siteAsciiDocConfig, siteCatalog, uiCatalog, contentCatalog)
